...
async function loadPersianFont(text: string) {
  const cssUrl = `https://fonts.googleapis.com/css2?family=Vazirmatn:wght@800&text=${encodeURIComponent(
    text
  )}`;
...
export default async function OpengraphImage() {
  ...
  return new ImageResponse(
    ...
    {
      ...size,
      fonts: [{ name: "Vazirmatn", data: fontData, weight: 800, style: "normal" }],
    }
  );
}
